...
inline int inGabrielSphere_exact(double qx, double qy, double qz, double ax, double ay, double az, double bx, double by, double bz, double cx, double cy, double cz)
{
   double bax[2];
   expansionObject::two_Diff(bx, ax, bax);
   double bay[2];
   expansionObject::two_Diff(by, ay, bay);
   double baz[2];
   expansionObject::two_Diff(bz, az, baz);
   double cax[2];
   expansionObject::two_Diff(cx, ax, cax);
   double cay[2];
   expansionObject::two_Diff(cy, ay, cay);
   double caz[2];
   expansionObject::two_Diff(cz, az, caz);
   double qax[2];
   expansionObject::two_Diff(qx, ax, qax);
   double qay[2];
   expansionObject::two_Diff(qy, ay, qay);
   double qaz[2];
   expansionObject::two_Diff(qz, az, qaz);
   double cx1[8];
   int cx1_len = expansionObject::Gen_Product(2, bay, 2, caz, cx1);
   double cx2[8];
   int cx2_len = expansionObject::Gen_Product(2, baz, 2, cay, cx2);
   double crossbcx[16];
   int crossbcx_len = expansionObject::Gen_Diff(cx1_len, cx1, cx2_len, cx2, crossbcx);
   double cy1[8];
   int cy1_len = expansionObject::Gen_Product(2, baz, 2, cax, cy1);
   double cy2[8];
   int cy2_len = expansionObject::Gen_Product(2, bax, 2, caz, cy2);
   double crossbcy[16];
   int crossbcy_len = expansionObject::Gen_Diff(cy1_len, cy1, cy2_len, cy2, crossbcy);
   double cz1[8];
   int cz1_len = expansionObject::Gen_Product(2, bax, 2, cay, cz1);
   double cz2[8];
   int cz2_len = expansionObject::Gen_Product(2, bay, 2, cax, cz2);
   double crossbcz[16];
   int crossbcz_len = expansionObject::Gen_Diff(cz1_len, cz1, cz2_len, cz2, crossbcz);
   double ba2x[8];
   int ba2x_len = expansionObject::Gen_Product(2, bax, 2, bax, ba2x);
   double ba2y[8];
   int ba2y_len = expansionObject::Gen_Product(2, bay, 2, bay, ba2y);
   double ba2z[8];
   int ba2z_len = expansionObject::Gen_Product(2, baz, 2, baz, ba2z);
   double ba2t[16];
   int ba2t_len = expansionObject::Gen_Sum(ba2x_len, ba2x, ba2y_len, ba2y, ba2t);
   double ba2[24];
   int ba2_len = expansionObject::Gen_Sum(ba2t_len, ba2t, ba2z_len, ba2z, ba2);
   double ca2x[8];
   int ca2x_len = expansionObject::Gen_Product(2, cax, 2, cax, ca2x);
   double ca2y[8];
   int ca2y_len = expansionObject::Gen_Product(2, cay, 2, cay, ca2y);
   double ca2z[8];
   int ca2z_len = expansionObject::Gen_Product(2, caz, 2, caz, ca2z);
   double ca2t[16];
   int ca2t_len = expansionObject::Gen_Sum(ca2x_len, ca2x, ca2y_len, ca2y, ca2t);
   double ca2[24];
   int ca2_len = expansionObject::Gen_Sum(ca2t_len, ca2t, ca2z_len, ca2z, ca2);
   double calx_p[32], *calx = calx_p;
   int calx_len = expansionObject::Gen_Product_With_PreAlloc(2, cax, ba2_len, ba2, &calx, 32);
   double caly_p[32], *caly = caly_p;
   int caly_len = expansionObject::Gen_Product_With_PreAlloc(2, cay, ba2_len, ba2, &caly, 32);
   double calz_p[32], *calz = calz_p;
   int calz_len = expansionObject::Gen_Product_With_PreAlloc(2, caz, ba2_len, ba2, &calz, 32);
   double balx_p[32], *balx = balx_p;
   int balx_len = expansionObject::Gen_Product_With_PreAlloc(2, bax, ca2_len, ca2, &balx, 32);
   double baly_p[32], *baly = baly_p;
   int baly_len = expansionObject::Gen_Product_With_PreAlloc(2, bay, ca2_len, ca2, &baly, 32);
   double balz_p[32], *balz = balz_p;
   int balz_len = expansionObject::Gen_Product_With_PreAlloc(2, baz, ca2_len, ca2, &balz, 32);
   double abcx_p[32], *abcx = abcx_p;
   int abcx_len = expansionObject::Gen_Diff_With_PreAlloc(calx_len, calx, balx_len, balx, &abcx, 32);
   double abcy_p[32], *abcy = abcy_p;
   int abcy_len = expansionObject::Gen_Diff_With_PreAlloc(caly_len, caly, baly_len, baly, &abcy, 32);
   double abcz_p[32], *abcz = abcz_p;
   int abcz_len = expansionObject::Gen_Diff_With_PreAlloc(calz_len, calz, balz_len, balz, &abcz, 32);
   double kx1_p[32], *kx1 = kx1_p;
   int kx1_len = expansionObject::Gen_Product_With_PreAlloc(abcy_len, abcy, crossbcz_len, crossbcz, &kx1, 32);
   double kx2_p[32], *kx2 = kx2_p;
   int kx2_len = expansionObject::Gen_Product_With_PreAlloc(abcz_len, abcz, crossbcy_len, crossbcy, &kx2, 32);
   double ccax_p[32], *ccax = ccax_p;
   int ccax_len = expansionObject::Gen_Diff_With_PreAlloc(kx1_len, kx1, kx2_len, kx2, &ccax, 32);
   double ky1_p[32], *ky1 = ky1_p;
   int ky1_len = expansionObject::Gen_Product_With_PreAlloc(abcz_len, abcz, crossbcx_len, crossbcx, &ky1, 32);
   double ky2_p[32], *ky2 = ky2_p;
   int ky2_len = expansionObject::Gen_Product_With_PreAlloc(abcx_len, abcx, crossbcz_len, crossbcz, &ky2, 32);
   double ccay_p[32], *ccay = ccay_p;
   int ccay_len = expansionObject::Gen_Diff_With_PreAlloc(ky1_len, ky1, ky2_len, ky2, &ccay, 32);
   double kz1_p[32], *kz1 = kz1_p;
   int kz1_len = expansionObject::Gen_Product_With_PreAlloc(abcx_len, abcx, crossbcy_len, crossbcy, &kz1, 32);
   double kz2_p[32], *kz2 = kz2_p;
   int kz2_len = expansionObject::Gen_Product_With_PreAlloc(abcy_len, abcy, crossbcx_len, crossbcx, &kz2, 32);
   double ccaz_p[32], *ccaz = ccaz_p;
   int ccaz_len = expansionObject::Gen_Diff_With_PreAlloc(kz1_len, kz1, kz2_len, kz2, &ccaz, 32);
   double cr2x_p[32], *cr2x = cr2x_p;
   int cr2x_len = expansionObject::Gen_Product_With_PreAlloc(crossbcx_len, crossbcx, crossbcx_len, crossbcx, &cr2x, 32);
   double cr2y_p[32], *cr2y = cr2y_p;
   int cr2y_len = expansionObject::Gen_Product_With_PreAlloc(crossbcy_len, crossbcy, crossbcy_len, crossbcy, &cr2y, 32);
   double cr2z_p[32], *cr2z = cr2z_p;
   int cr2z_len = expansionObject::Gen_Product_With_PreAlloc(crossbcz_len, crossbcz, crossbcz_len, crossbcz, &cr2z, 32);
   double cr2t_p[32], *cr2t = cr2t_p;
   int cr2t_len = expansionObject::Gen_Sum_With_PreAlloc(cr2x_len, cr2x, cr2y_len, cr2y, &cr2t, 32);
   double c2_p[32], *c2 = c2_p;
   int c2_len = expansionObject::Gen_Sum_With_PreAlloc(cr2t_len, cr2t, cr2z_len, cr2z, &c2, 32);
   double c22_p[32], *c22 = c22_p;
   int c22_len = expansionObject::Double_With_PreAlloc(c2_len, c2, &c22, 32);
   double qa1x_p[32], *qa1x = qa1x_p;
   int qa1x_len = expansionObject::Gen_Product_With_PreAlloc(2, qax, c2_len, c22, &qa1x, 32);
   double qa1y_p[32], *qa1y = qa1y_p;
   int qa1y_len = expansionObject::Gen_Product_With_PreAlloc(2, qay, c2_len, c22, &qa1y, 32);
   double qa1z_p[32], *qa1z = qa1z_p;
   int qa1z_len = expansionObject::Gen_Product_With_PreAlloc(2, qaz, c2_len, c22, &qa1z, 32);
   double qa2x_p[32], *qa2x = qa2x_p;
   int qa2x_len = expansionObject::Gen_Diff_With_PreAlloc(qa1x_len, qa1x, ccax_len, ccax, &qa2x, 32);
   double qa2y_p[32], *qa2y = qa2y_p;
   int qa2y_len = expansionObject::Gen_Diff_With_PreAlloc(qa1y_len, qa1y, ccay_len, ccay, &qa2y, 32);
   double qa2z_p[32], *qa2z = qa2z_p;
   int qa2z_len = expansionObject::Gen_Diff_With_PreAlloc(qa1z_len, qa1z, ccaz_len, ccaz, &qa2z, 32);
   double r1x_p[32], *r1x = r1x_p;
   int r1x_len = expansionObject::Gen_Product_With_PreAlloc(qa2x_len, qa2x, qa2x_len, qa2x, &r1x, 32);
   double r1y_p[32], *r1y = r1y_p;
   int r1y_len = expansionObject::Gen_Product_With_PreAlloc(qa2y_len, qa2y, qa2y_len, qa2y, &r1y, 32);
   double r1z_p[32], *r1z = r1z_p;
   int r1z_len = expansionObject::Gen_Product_With_PreAlloc(qa2z_len, qa2z, qa2z_len, qa2z, &r1z, 32);
   double r1t_p[32], *r1t = r1t_p;
   int r1t_len = expansionObject::Gen_Sum_With_PreAlloc(r1x_len, r1x, r1y_len, r1y, &r1t, 32);
   double r1_p[32], *r1 = r1_p;
   int r1_len = expansionObject::Gen_Sum_With_PreAlloc(r1t_len, r1t, r1z_len, r1z, &r1, 32);
   double r2x_p[32], *r2x = r2x_p;
   int r2x_len = expansionObject::Gen_Product_With_PreAlloc(ccax_len, ccax, ccax_len, ccax, &r2x, 32);
   double r2y_p[32], *r2y = r2y_p;
   int r2y_len = expansionObject::Gen_Product_With_PreAlloc(ccay_len, ccay, ccay_len, ccay, &r2y, 32);
   double r2z_p[32], *r2z = r2z_p;
   int r2z_len = expansionObject::Gen_Product_With_PreAlloc(ccaz_len, ccaz, ccaz_len, ccaz, &r2z, 32);
   double r2t_p[32], *r2t = r2t_p;
   int r2t_len = expansionObject::Gen_Sum_With_PreAlloc(r2x_len, r2x, r2y_len, r2y, &r2t, 32);
   double r2_p[32], *r2 = r2_p;
   int r2_len = expansionObject::Gen_Sum_With_PreAlloc(r2t_len, r2t, r2z_len, r2z, &r2, 32);
   double ret_p[32], *ret = ret_p;
   int ret_len = expansionObject::Gen_Diff_With_PreAlloc(r1_len, r1, r2_len, r2, &ret, 32);

   double return_value = ret[ret_len - 1];
   if (ret_p != ret) FreeDoubles(ret);
   if (r2_p != r2) FreeDoubles(r2);
   if (r2t_p != r2t) FreeDoubles(r2t);
   if (r2z_p != r2z) FreeDoubles(r2z);
   if (r2y_p != r2y) FreeDoubles(r2y);
   if (r2x_p != r2x) FreeDoubles(r2x);
   if (r1_p != r1) FreeDoubles(r1);
   if (r1t_p != r1t) FreeDoubles(r1t);
   if (r1z_p != r1z) FreeDoubles(r1z);
   if (r1y_p != r1y) FreeDoubles(r1y);
   if (r1x_p != r1x) FreeDoubles(r1x);
   if (qa2z_p != qa2z) FreeDoubles(qa2z);
   if (qa2y_p != qa2y) FreeDoubles(qa2y);
   if (qa2x_p != qa2x) FreeDoubles(qa2x);
   if (qa1z_p != qa1z) FreeDoubles(qa1z);
   if (qa1y_p != qa1y) FreeDoubles(qa1y);
   if (qa1x_p != qa1x) FreeDoubles(qa1x);
   if (c22_p != c22) FreeDoubles(c22);
   if (c2_p != c2) FreeDoubles(c2);
   if (cr2t_p != cr2t) FreeDoubles(cr2t);
   if (cr2z_p != cr2z) FreeDoubles(cr2z);
   if (cr2y_p != cr2y) FreeDoubles(cr2y);
   if (cr2x_p != cr2x) FreeDoubles(cr2x);
   if (ccaz_p != ccaz) FreeDoubles(ccaz);
   if (kz2_p != kz2) FreeDoubles(kz2);
   if (kz1_p != kz1) FreeDoubles(kz1);
   if (ccay_p != ccay) FreeDoubles(ccay);
   if (ky2_p != ky2) FreeDoubles(ky2);
   if (ky1_p != ky1) FreeDoubles(ky1);
   if (ccax_p != ccax) FreeDoubles(ccax);
   if (kx2_p != kx2) FreeDoubles(kx2);
   if (kx1_p != kx1) FreeDoubles(kx1);
   if (abcz_p != abcz) FreeDoubles(abcz);
   if (abcy_p != abcy) FreeDoubles(abcy);
   if (abcx_p != abcx) FreeDoubles(abcx);
   if (balz_p != balz) FreeDoubles(balz);
   if (baly_p != baly) FreeDoubles(baly);
   if (balx_p != balx) FreeDoubles(balx);
   if (calz_p != calz) FreeDoubles(calz);
   if (caly_p != caly) FreeDoubles(caly);
   if (calx_p != calx) FreeDoubles(calx);
...
inline int inGabrielSphere(double qx, double qy, double qz, double ax, double ay, double az, double bx, double by, double bz, double cx, double cy, double cz)
{
   ...
   if (ret != Filtered_Sign::UNCERTAIN) return ret;
   return inGabrielSphere_exact(qx, qy, qz, ax, ay, az, bx, by, bz, cx, cy, cz);
}
...
inline int inGabrielSphere_EIEE_exact(const genericPoint& a, double qx, double qy, double qz, double bx, double by, double bz, double cx, double cy, double cz)
{
 double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
   feclearexcept(FE_ALL_EXCEPT);
#endif
 double l2x_p[16], *l2x = l2x_p, l2y_p[16], *l2y = l2y_p, l2z_p[16], *l2z = l2z_p, d2_p[16], *d2 = d2_p;
 int l2x_len = 16, l2y_len = 16, l2z_len = 16, d2_len = 16;
 a.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
 if ((d2[d2_len - 1] != 0))
 {
   double bxd2_p[16], *bxd2 = bxd2_p;
   int bxd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, bx, &bxd2, 16);
   double byd2_p[16], *byd2 = byd2_p;
   int byd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, by, &byd2, 16);
   double bzd2_p[16], *bzd2 = bzd2_p;
   int bzd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, bz, &bzd2, 16);
   double cxd2_p[16], *cxd2 = cxd2_p;
   int cxd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, cx, &cxd2, 16);
   double cyd2_p[16], *cyd2 = cyd2_p;
   int cyd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, cy, &cyd2, 16);
   double czd2_p[16], *czd2 = czd2_p;
   int czd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, cz, &czd2, 16);
   double qxd2_p[16], *qxd2 = qxd2_p;
   int qxd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, qx, &qxd2, 16);
   double qyd2_p[16], *qyd2 = qyd2_p;
   int qyd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, qy, &qyd2, 16);
   double qzd2_p[16], *qzd2 = qzd2_p;
   int qzd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, qz, &qzd2, 16);
   double bax_p[16], *bax = bax_p;
   int bax_len = expansionObject::Gen_Diff_With_PreAlloc(bxd2_len, bxd2, l2x_len, l2x, &bax, 16);
   double bay_p[16], *bay = bay_p;
   int bay_len = expansionObject::Gen_Diff_With_PreAlloc(byd2_len, byd2, l2y_len, l2y, &bay, 16);
   double baz_p[16], *baz = baz_p;
   int baz_len = expansionObject::Gen_Diff_With_PreAlloc(bzd2_len, bzd2, l2z_len, l2z, &baz, 16);
   double cax_p[16], *cax = cax_p;
   int cax_len = expansionObject::Gen_Diff_With_PreAlloc(cxd2_len, cxd2, l2x_len, l2x, &cax, 16);
   double cay_p[16], *cay = cay_p;
   int cay_len = expansionObject::Gen_Diff_With_PreAlloc(cyd2_len, cyd2, l2y_len, l2y, &cay, 16);
   double caz_p[16], *caz = caz_p;
   int caz_len = expansionObject::Gen_Diff_With_PreAlloc(czd2_len, czd2, l2z_len, l2z, &caz, 16);
   double qax_p[16], *qax = qax_p;
   int qax_len = expansionObject::Gen_Diff_With_PreAlloc(qxd2_len, qxd2, l2x_len, l2x, &qax, 16);
   double qay_p[16], *qay = qay_p;
   int qay_len = expansionObject::Gen_Diff_With_PreAlloc(qyd2_len, qyd2, l2y_len, l2y, &qay, 16);
   double qaz_p[16], *qaz = qaz_p;
   int qaz_len = expansionObject::Gen_Diff_With_PreAlloc(qzd2_len, qzd2, l2z_len, l2z, &qaz, 16);
   double cx1_p[16], *cx1 = cx1_p;
   int cx1_len = expansionObject::Gen_Product_With_PreAlloc(bay_len, bay, caz_len, caz, &cx1, 16);
   double cx2_p[16], *cx2 = cx2_p;
   int cx2_len = expansionObject::Gen_Product_With_PreAlloc(baz_len, baz, cay_len, cay, &cx2, 16);
   double crossbcx_p[16], *crossbcx = crossbcx_p;
   int crossbcx_len = expansionObject::Gen_Diff_With_PreAlloc(cx1_len, cx1, cx2_len, cx2, &crossbcx, 16);
   double cy1_p[16], *cy1 = cy1_p;
   int cy1_len = expansionObject::Gen_Product_With_PreAlloc(baz_len, baz, cax_len, cax, &cy1, 16);
   double cy2_p[16], *cy2 = cy2_p;
   int cy2_len = expansionObject::Gen_Product_With_PreAlloc(bax_len, bax, caz_len, caz, &cy2, 16);
   double crossbcy_p[16], *crossbcy = crossbcy_p;
   int crossbcy_len = expansionObject::Gen_Diff_With_PreAlloc(cy1_len, cy1, cy2_len, cy2, &crossbcy, 16);
   double cz1_p[16], *cz1 = cz1_p;
   int cz1_len = expansionObject::Gen_Product_With_PreAlloc(bax_len, bax, cay_len, cay, &cz1, 16);
   double cz2_p[16], *cz2 = cz2_p;
   int cz2_len = expansionObject::Gen_Product_With_PreAlloc(bay_len, bay, cax_len, cax, &cz2, 16);
   double crossbcz_p[16], *crossbcz = crossbcz_p;
   int crossbcz_len = expansionObject::Gen_Diff_With_PreAlloc(cz1_len, cz1, cz2_len, cz2, &crossbcz, 16);
   double ba2x_p[16], *ba2x = ba2x_p;
   int ba2x_len = expansionObject::Gen_Product_With_PreAlloc(bax_len, bax, bax_len, bax, &ba2x, 16);
   double ba2y_p[16], *ba2y = ba2y_p;
   int ba2y_len = expansionObject::Gen_Product_With_PreAlloc(bay_len, bay, bay_len, bay, &ba2y, 16);
   double ba2z_p[16], *ba2z = ba2z_p;
   int ba2z_len = expansionObject::Gen_Product_With_PreAlloc(baz_len, baz, baz_len, baz, &ba2z, 16);
   double ba2t_p[16], *ba2t = ba2t_p;
   int ba2t_len = expansionObject::Gen_Sum_With_PreAlloc(ba2x_len, ba2x, ba2y_len, ba2y, &ba2t, 16);
   double ba2_p[16], *ba2 = ba2_p;
   int ba2_len = expansionObject::Gen_Sum_With_PreAlloc(ba2t_len, ba2t, ba2z_len, ba2z, &ba2, 16);
   double ca2x_p[16], *ca2x = ca2x_p;
   int ca2x_len = expansionObject::Gen_Product_With_PreAlloc(cax_len, cax, cax_len, cax, &ca2x, 16);
   double ca2y_p[16], *ca2y = ca2y_p;
   int ca2y_len = expansionObject::Gen_Product_With_PreAlloc(cay_len, cay, cay_len, cay, &ca2y, 16);
   double ca2z_p[16], *ca2z = ca2z_p;
   int ca2z_len = expansionObject::Gen_Product_With_PreAlloc(caz_len, caz, caz_len, caz, &ca2z, 16);
   double ca2t_p[16], *ca2t = ca2t_p;
   int ca2t_len = expansionObject::Gen_Sum_With_PreAlloc(ca2x_len, ca2x, ca2y_len, ca2y, &ca2t, 16);
   double ca2_p[16], *ca2 = ca2_p;
   int ca2_len = expansionObject::Gen_Sum_With_PreAlloc(ca2t_len, ca2t, ca2z_len, ca2z, &ca2, 16);
   double calx_p[16], *calx = calx_p;
   int calx_len = expansionObject::Gen_Product_With_PreAlloc(cax_len, cax, ba2_len, ba2, &calx, 16);
   double caly_p[16], *caly = caly_p;
   int caly_len = expansionObject::Gen_Product_With_PreAlloc(cay_len, cay, ba2_len, ba2, &caly, 16);
   double calz_p[16], *calz = calz_p;
   int calz_len = expansionObject::Gen_Product_With_PreAlloc(caz_len, caz, ba2_len, ba2, &calz, 16);
   double balx_p[16], *balx = balx_p;
   int balx_len = expansionObject::Gen_Product_With_PreAlloc(bax_len, bax, ca2_len, ca2, &balx, 16);
   double baly_p[16], *baly = baly_p;
   int baly_len = expansionObject::Gen_Product_With_PreAlloc(bay_len, bay, ca2_len, ca2, &baly, 16);
   double balz_p[16], *balz = balz_p;
   int balz_len = expansionObject::Gen_Product_With_PreAlloc(baz_len, baz, ca2_len, ca2, &balz, 16);
   double abcx_p[16], *abcx = abcx_p;
   int abcx_len = expansionObject::Gen_Diff_With_PreAlloc(calx_len, calx, balx_len, balx, &abcx, 16);
   double abcy_p[16], *abcy = abcy_p;
   int abcy_len = expansionObject::Gen_Diff_With_PreAlloc(caly_len, caly, baly_len, baly, &abcy, 16);
   double abcz_p[16], *abcz = abcz_p;
   int abcz_len = expansionObject::Gen_Diff_With_PreAlloc(calz_len, calz, balz_len, balz, &abcz, 16);
   double kx1_p[16], *kx1 = kx1_p;
   int kx1_len = expansionObject::Gen_Product_With_PreAlloc(abcy_len, abcy, crossbcz_len, crossbcz, &kx1, 16);
   double kx2_p[16], *kx2 = kx2_p;
   int kx2_len = expansionObject::Gen_Product_With_PreAlloc(abcz_len, abcz, crossbcy_len, crossbcy, &kx2, 16);
   double ccax_p[16], *ccax = ccax_p;
   int ccax_len = expansionObject::Gen_Diff_With_PreAlloc(kx1_len, kx1, kx2_len, kx2, &ccax, 16);
   double ky1_p[16], *ky1 = ky1_p;
   int ky1_len = expansionObject::Gen_Product_With_PreAlloc(abcz_len, abcz, crossbcx_len, crossbcx, &ky1, 16);
   double ky2_p[16], *ky2 = ky2_p;
   int ky2_len = expansionObject::Gen_Product_With_PreAlloc(abcx_len, abcx, crossbcz_len, crossbcz, &ky2, 16);
   double ccay_p[16], *ccay = ccay_p;
   int ccay_len = expansionObject::Gen_Diff_With_PreAlloc(ky1_len, ky1, ky2_len, ky2, &ccay, 16);
   double kz1_p[16], *kz1 = kz1_p;
   int kz1_len = expansionObject::Gen_Product_With_PreAlloc(abcx_len, abcx, crossbcy_len, crossbcy, &kz1, 16);
   double kz2_p[16], *kz2 = kz2_p;
   int kz2_len = expansionObject::Gen_Product_With_PreAlloc(abcy_len, abcy, crossbcx_len, crossbcx, &kz2, 16);
   double ccaz_p[16], *ccaz = ccaz_p;
   int ccaz_len = expansionObject::Gen_Diff_With_PreAlloc(kz1_len, kz1, kz2_len, kz2, &ccaz, 16);
   double cr2x_p[16], *cr2x = cr2x_p;
   int cr2x_len = expansionObject::Gen_Product_With_PreAlloc(crossbcx_len, crossbcx, crossbcx_len, crossbcx, &cr2x, 16);
   double cr2y_p[16], *cr2y = cr2y_p;
   int cr2y_len = expansionObject::Gen_Product_With_PreAlloc(crossbcy_len, crossbcy, crossbcy_len, crossbcy, &cr2y, 16);
   double cr2z_p[16], *cr2z = cr2z_p;
   int cr2z_len = expansionObject::Gen_Product_With_PreAlloc(crossbcz_len, crossbcz, crossbcz_len, crossbcz, &cr2z, 16);
   double cr2t_p[16], *cr2t = cr2t_p;
   int cr2t_len = expansionObject::Gen_Sum_With_PreAlloc(cr2x_len, cr2x, cr2y_len, cr2y, &cr2t, 16);
   double c2_p[16], *c2 = c2_p;
   int c2_len = expansionObject::Gen_Sum_With_PreAlloc(cr2t_len, cr2t, cr2z_len, cr2z, &c2, 16);
   double c22_p[16], *c22 = c22_p;
   int c22_len = expansionObject::Double_With_PreAlloc(c2_len, c2, &c22, 16);
   double qa1x_p[16], *qa1x = qa1x_p;
   int qa1x_len = expansionObject::Gen_Product_With_PreAlloc(qax_len, qax, c2_len, c22, &qa1x, 16);
   double qa1y_p[16], *qa1y = qa1y_p;
   int qa1y_len = expansionObject::Gen_Product_With_PreAlloc(qay_len, qay, c2_len, c22, &qa1y, 16);
   double qa1z_p[16], *qa1z = qa1z_p;
   int qa1z_len = expansionObject::Gen_Product_With_PreAlloc(qaz_len, qaz, c2_len, c22, &qa1z, 16);
   double qa2x_p[16], *qa2x = qa2x_p;
   int qa2x_len = expansionObject::Gen_Diff_With_PreAlloc(qa1x_len, qa1x, ccax_len, ccax, &qa2x, 16);
   double qa2y_p[16], *qa2y = qa2y_p;
   int qa2y_len = expansionObject::Gen_Diff_With_PreAlloc(qa1y_len, qa1y, ccay_len, ccay, &qa2y, 16);
   double qa2z_p[16], *qa2z = qa2z_p;
   int qa2z_len = expansionObject::Gen_Diff_With_PreAlloc(qa1z_len, qa1z, ccaz_len, ccaz, &qa2z, 16);
   double r1x_p[16], *r1x = r1x_p;
   int r1x_len = expansionObject::Gen_Product_With_PreAlloc(qa2x_len, qa2x, qa2x_len, qa2x, &r1x, 16);
   double r1y_p[16], *r1y = r1y_p;
   int r1y_len = expansionObject::Gen_Product_With_PreAlloc(qa2y_len, qa2y, qa2y_len, qa2y, &r1y, 16);
   double r1z_p[16], *r1z = r1z_p;
   int r1z_len = expansionObject::Gen_Product_With_PreAlloc(qa2z_len, qa2z, qa2z_len, qa2z, &r1z, 16);
   double r1t_p[16], *r1t = r1t_p;
   int r1t_len = expansionObject::Gen_Sum_With_PreAlloc(r1x_len, r1x, r1y_len, r1y, &r1t, 16);
   double r1_p[16], *r1 = r1_p;
   int r1_len = expansionObject::Gen_Sum_With_PreAlloc(r1t_len, r1t, r1z_len, r1z, &r1, 16);
   double r2x_p[16], *r2x = r2x_p;
   int r2x_len = expansionObject::Gen_Product_With_PreAlloc(ccax_len, ccax, ccax_len, ccax, &r2x, 16);
   double r2y_p[16], *r2y = r2y_p;
   int r2y_len = expansionObject::Gen_Product_With_PreAlloc(ccay_len, ccay, ccay_len, ccay, &r2y, 16);
   double r2z_p[16], *r2z = r2z_p;
   int r2z_len = expansionObject::Gen_Product_With_PreAlloc(ccaz_len, ccaz, ccaz_len, ccaz, &r2z, 16);
   double r2t_p[16], *r2t = r2t_p;
   int r2t_len = expansionObject::Gen_Sum_With_PreAlloc(r2x_len, r2x, r2y_len, r2y, &r2t, 16);
   double r2_p[16], *r2 = r2_p;
   int r2_len = expansionObject::Gen_Sum_With_PreAlloc(r2t_len, r2t, r2z_len, r2z, &r2, 16);
   double ret_p[16], *ret = ret_p;
   int ret_len = expansionObject::Gen_Diff_With_PreAlloc(r1_len, r1, r2_len, r2, &ret, 16);

   return_value = ret[ret_len - 1];
   if (ret_p != ret) FreeDoubles(ret);
   if (r2_p != r2) FreeDoubles(r2);
   if (r2t_p != r2t) FreeDoubles(r2t);
   if (r2z_p != r2z) FreeDoubles(r2z);
   ...
   if (caly_p != caly) FreeDoubles(caly);
   if (calx_p != calx) FreeDoubles(calx);
   if (ca2_p != ca2) FreeDoubles(ca2);
   if (ca2t_p != ca2t) FreeDoubles(ca2t);
   if (ca2z_p != ca2z) FreeDoubles(ca2z);
   if (ca2y_p != ca2y) FreeDoubles(ca2y);
   if (ca2x_p != ca2x) FreeDoubles(ca2x);
   if (ba2_p != ba2) FreeDoubles(ba2);
   if (ba2t_p != ba2t) FreeDoubles(ba2t);
   if (ba2z_p != ba2z) FreeDoubles(ba2z);
   if (ba2y_p != ba2y) FreeDoubles(ba2y);
   if (ba2x_p != ba2x) FreeDoubles(ba2x);
   if (crossbcz_p != crossbcz) FreeDoubles(crossbcz);
   if (cz2_p != cz2) FreeDoubles(cz2);
   if (cz1_p != cz1) FreeDoubles(cz1);
   if (crossbcy_p != crossbcy) FreeDoubles(crossbcy);
   if (cy2_p != cy2) FreeDoubles(cy2);
   if (cy1_p != cy1) FreeDoubles(cy1);
   if (crossbcx_p != crossbcx) FreeDoubles(crossbcx);
   if (cx2_p != cx2) FreeDoubles(cx2);
   if (cx1_p != cx1) FreeDoubles(cx1);
   if (qaz_p != qaz) FreeDoubles(qaz);
   if (qay_p != qay) FreeDoubles(qay);
   if (qax_p != qax) FreeDoubles(qax);
   if (caz_p != caz) FreeDoubles(caz);
   if (cay_p != cay) FreeDoubles(cay);
   if (cax_p != cax) FreeDoubles(cax);
   if (baz_p != baz) FreeDoubles(baz);
   if (bay_p != bay) FreeDoubles(bay);
   if (bax_p != bax) FreeDoubles(bax);
   if (qzd2_p != qzd2) FreeDoubles(qzd2);
   if (qyd2_p != qyd2) FreeDoubles(qyd2);
   if (qxd2_p != qxd2) FreeDoubles(qxd2);
   if (czd2_p != czd2) FreeDoubles(czd2);
   if (cyd2_p != cyd2) FreeDoubles(cyd2);
   if (cxd2_p != cxd2) FreeDoubles(cxd2);
   if (bzd2_p != bzd2) FreeDoubles(bzd2);
   if (byd2_p != byd2) FreeDoubles(byd2);
   if (bxd2_p != bxd2) FreeDoubles(bxd2);
 }

#ifdef CHECK_FOR_XYZERFLOWS
   if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW)) return_value = inGabrielSphere_EIEE_bigfloat(a, qx, qy, qz, bx, by, bz, cx, cy, cz);
#endif
...
inline int inGabrielSphere_EIEE(const genericPoint& a, double qx, double qy, double qz, double bx, double by, double bz, double cx, double cy, double cz)
{
   ...
   if (ret != Filtered_Sign::UNCERTAIN) return ret;
   return inGabrielSphere_EIEE_exact(a, qx, qy, qz, bx, by, bz, cx, cy, cz);
}
...
inline int inGabrielSphere_EIIE_exact(const genericPoint& a, const genericPoint& b, double qx, double qy, double qz, double cx, double cy, double cz)
{
 double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
   feclearexcept(FE_ALL_EXCEPT);
#endif
 double l2x_p[16], *l2x = l2x_p, l2y_p[16], *l2y = l2y_p, l2z_p[16], *l2z = l2z_p, d2_p[16], *d2 = d2_p, l3x_p[16], *l3x = l3x_p, l3y_p[16], *l3y = l3y_p, l3z_p[16], *l3z = l3z_p, d3_p[16], *d3 = d3_p;
 int l2x_len = 16, l2y_len = 16, l2z_len = 16, d2_len = 16, l3x_len = 16, l3y_len = 16, l3z_len = 16, d3_len = 16;
 a.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
 b.getExactLambda(&l3x, l3x_len, &l3y, l3y_len, &l3z, l3z_len, &d3, d3_len);
 if ((d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0))
 {
   double d23_p[16], *d23 = d23_p;
   int d23_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, d3_len, d3, &d23, 16);
   double bxd2_p[16], *bxd2 = bxd2_p;
   int bxd2_len = expansionObject::Gen_Product_With_PreAlloc(l3x_len, l3x, d2_len, d2, &bxd2, 16);
   double byd2_p[16], *byd2 = byd2_p;
   int byd2_len = expansionObject::Gen_Product_With_PreAlloc(l3y_len, l3y, d2_len, d2, &byd2, 16);
   double bzd2_p[16], *bzd2 = bzd2_p;
   int bzd2_len = expansionObject::Gen_Product_With_PreAlloc(l3z_len, l3z, d2_len, d2, &bzd2, 16);
   double cxd2_p[16], *cxd2 = cxd2_p;
   int cxd2_len = expansionObject::Gen_Scale_With_PreAlloc(d23_len, d23, cx, &cxd2, 16);
   double cyd2_p[16], *cyd2 = cyd2_p;
   int cyd2_len = expansionObject::Gen_Scale_With_PreAlloc(d23_len, d23, cy, &cyd2, 16);
   double czd2_p[16], *czd2 = czd2_p;
   int czd2_len = expansionObject::Gen_Scale_With_PreAlloc(d23_len, d23, cz, &czd2, 16);
   double qxd2_p[16], *qxd2 = qxd2_p;
   int qxd2_len = expansionObject::Gen_Scale_With_PreAlloc(d23_len, d23, qx, &qxd2, 16);
   double qyd2_p[16], *qyd2 = qyd2_p;
   int qyd2_len = expansionObject::Gen_Scale_With_PreAlloc(d23_len, d23, qy, &qyd2, 16);
   double qzd2_p[16], *qzd2 = qzd2_p;
   int qzd2_len = expansionObject::Gen_Scale_With_PreAlloc(d23_len, d23, qz, &qzd2, 16);
   double l2x3_p[16], *l2x3 = l2x3_p;
   int l2x3_len = expansionObject::Gen_Product_With_PreAlloc(l2x_len, l2x, d3_len, d3, &l2x3, 16);
   double l2y3_p[16], *l2y3 = l2y3_p;
   int l2y3_len = expansionObject::Gen_Product_With_PreAlloc(l2y_len, l2y, d3_len, d3, &l2y3, 16);
   double l2z3_p[16], *l2z3 = l2z3_p;
   int l2z3_len = expansionObject::Gen_Product_With_PreAlloc(l2z_len, l2z, d3_len, d3, &l2z3, 16);
   double bax_p[16], *bax = bax_p;
   int bax_len = expansionObject::Gen_Diff_With_PreAlloc(bxd2_len, bxd2, l2x3_len, l2x3, &bax, 16);
   double bay_p[16], *bay = bay_p;
   int bay_len = expansionObject::Gen_Diff_With_PreAlloc(byd2_len, byd2, l2y3_len, l2y3, &bay, 16);
   double baz_p[16], *baz = baz_p;
   int baz_len = expansionObject::Gen_Diff_With_PreAlloc(bzd2_len, bzd2, l2z3_len, l2z3, &baz, 16);
   double cax_p[16], *cax = cax_p;
   int cax_len = expansionObject::Gen_Diff_With_PreAlloc(cxd2_len, cxd2, l2x3_len, l2x3, &cax, 16);
   double cay_p[16], *cay = cay_p;
   int cay_len = expansionObject::Gen_Diff_With_PreAlloc(cyd2_len, cyd2, l2y3_len, l2y3, &cay, 16);
   double caz_p[16], *caz = caz_p;
   int caz_len = expansionObject::Gen_Diff_With_PreAlloc(czd2_len, czd2, l2z3_len, l2z3, &caz, 16);
   double qax_p[16], *qax = qax_p;
   int qax_len = expansionObject::Gen_Diff_With_PreAlloc(qxd2_len, qxd2, l2x3_len, l2x3, &qax, 16);
   double qay_p[16], *qay = qay_p;
   int qay_len = expansionObject::Gen_Diff_With_PreAlloc(qyd2_len, qyd2, l2y3_len, l2y3, &qay, 16);
   double qaz_p[16], *qaz = qaz_p;
   int qaz_len = expansionObject::Gen_Diff_With_PreAlloc(qzd2_len, qzd2, l2z3_len, l2z3, &qaz, 16);
   double cx1_p[16], *cx1 = cx1_p;
   int cx1_len = expansionObject::Gen_Product_With_PreAlloc(bay_len, bay, caz_len, caz, &cx1, 16);
   double cx2_p[16], *cx2 = cx2_p;
   int cx2_len = expansionObject::Gen_Product_With_PreAlloc(baz_len, baz, cay_len, cay, &cx2, 16);
   ...
   if (bay_p != bay) FreeDoubles(bay);
   if (bax_p != bax) FreeDoubles(bax);
   if (l2z3_p != l2z3) FreeDoubles(l2z3);
   if (l2y3_p != l2y3) FreeDoubles(l2y3);
   if (l2x3_p != l2x3) FreeDoubles(l2x3);
   if (qzd2_p != qzd2) FreeDoubles(qzd2);
   if (qyd2_p != qyd2) FreeDoubles(qyd2);
   if (qxd2_p != qxd2) FreeDoubles(qxd2);
   if (czd2_p != czd2) FreeDoubles(czd2);
   ...
   if (byd2_p != byd2) FreeDoubles(byd2);
   if (bxd2_p != bxd2) FreeDoubles(bxd2);
   if (d23_p != d23) FreeDoubles(d23);
 }

#ifdef CHECK_FOR_XYZERFLOWS
   if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW)) return_value = inGabrielSphere_EIIE_bigfloat(a, b, qx, qy, qz, cx, cy, cz);
#endif
...
inline int inGabrielSphere_EIIE(const genericPoint& a, const genericPoint& b, double qx, double qy, double qz, double cx, double cy, double cz)
{
   ...
   if (ret != Filtered_Sign::UNCERTAIN) return ret;
   return inGabrielSphere_EIIE_exact(a, b, qx, qy, qz, cx, cy, cz);
}
...
inline int inGabrielSphere_EIII_exact(const genericPoint& a, const genericPoint& b, const genericPoint& c, double qx, double qy, double qz)
{
 double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
   feclearexcept(FE_ALL_EXCEPT);
#endif
 double l2x_p[16], *l2x = l2x_p, l2y_p[16], *l2y = l2y_p, l2z_p[16], *l2z = l2z_p, d2_p[16], *d2 = d2_p, l3x_p[16], *l3x = l3x_p, l3y_p[16], *l3y = l3y_p, l3z_p[16], *l3z = l3z_p, d3_p[16], *d3 = d3_p, l4x_p[16], *l4x = l4x_p, l4y_p[16], *l4y = l4y_p, l4z_p[16], *l4z = l4z_p, d4_p[16], *d4 = d4_p;
 int l2x_len = 16, l2y_len = 16, l2z_len = 16, d2_len = 16, l3x_len = 16, l3y_len = 16, l3z_len = 16, d3_len = 16, l4x_len = 16, l4y_len = 16, l4z_len = 16, d4_len = 16;
 a.getExactLambda(&l2x, l2x_len, &l2y, l2y_len, &l2z, l2z_len, &d2, d2_len);
 b.getExactLambda(&l3x, l3x_len, &l3y, l3y_len, &l3z, l3z_len, &d3, d3_len);
 c.getExactLambda(&l4x, l4x_len, &l4y, l4y_len, &l4z, l4z_len, &d4, d4_len);
 if ((d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0) && (d4[d4_len - 1] != 0))
 {
   double d23_p[16], *d23 = d23_p;
   int d23_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, d3_len, d3, &d23, 16);
   double d24_p[16], *d24 = d24_p;
   int d24_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, d4_len, d4, &d24, 16);
   double d34_p[16], *d34 = d34_p;
   int d34_len = expansionObject::Gen_Product_With_PreAlloc(d3_len, d3, d4_len, d4, &d34, 16);
   double d234_p[16], *d234 = d234_p;
   int d234_len = expansionObject::Gen_Product_With_PreAlloc(d23_len, d23, d4_len, d4, &d234, 16);
   double bxd2_p[16], *bxd2 = bxd2_p;
   int bxd2_len = expansionObject::Gen_Product_With_PreAlloc(l3x_len, l3x, d24_len, d24, &bxd2, 16);
   double byd2_p[16], *byd2 = byd2_p;
   int byd2_len = expansionObject::Gen_Product_With_PreAlloc(l3y_len, l3y, d24_len, d24, &byd2, 16);
   double bzd2_p[16], *bzd2 = bzd2_p;
   int bzd2_len = expansionObject::Gen_Product_With_PreAlloc(l3z_len, l3z, d24_len, d24, &bzd2, 16);
   double cxd2_p[16], *cxd2 = cxd2_p;
   int cxd2_len = expansionObject::Gen_Product_With_PreAlloc(l4x_len, l4x, d23_len, d23, &cxd2, 16);
   double cyd2_p[16], *cyd2 = cyd2_p;
   int cyd2_len = expansionObject::Gen_Product_With_PreAlloc(l4y_len, l4y, d23_len, d23, &cyd2, 16);
   double czd2_p[16], *czd2 = czd2_p;
   int czd2_len = expansionObject::Gen_Product_With_PreAlloc(l4z_len, l4z, d23_len, d23, &czd2, 16);
   double qxd2_p[16], *qxd2 = qxd2_p;
   int qxd2_len = expansionObject::Gen_Scale_With_PreAlloc(d234_len, d234, qx, &qxd2, 16);
   double qyd2_p[16], *qyd2 = qyd2_p;
   int qyd2_len = expansionObject::Gen_Scale_With_PreAlloc(d234_len, d234, qy, &qyd2, 16);
   double qzd2_p[16], *qzd2 = qzd2_p;
   int qzd2_len = expansionObject::Gen_Scale_With_PreAlloc(d234_len, d234, qz, &qzd2, 16);
   double l2xm_p[16], *l2xm = l2xm_p;
   int l2xm_len = expansionObject::Gen_Product_With_PreAlloc(l2x_len, l2x, d34_len, d34, &l2xm, 16);
   double l2ym_p[16], *l2ym = l2ym_p;
   int l2ym_len = expansionObject::Gen_Product_With_PreAlloc(l2y_len, l2y, d34_len, d34, &l2ym, 16);
   double l2zm_p[16], *l2zm = l2zm_p;
   int l2zm_len = expansionObject::Gen_Product_With_PreAlloc(l2z_len, l2z, d34_len, d34, &l2zm, 16);
   double bax_p[16], *bax = bax_p;
   int bax_len = expansionObject::Gen_Diff_With_PreAlloc(bxd2_len, bxd2, l2xm_len, l2xm, &bax, 16);
   double bay_p[16], *bay = bay_p;
   int bay_len = expansionObject::Gen_Diff_With_PreAlloc(byd2_len, byd2, l2ym_len, l2ym, &bay, 16);
   double baz_p[16], *baz = baz_p;
   int baz_len = expansionObject::Gen_Diff_With_PreAlloc(bzd2_len, bzd2, l2zm_len, l2zm, &baz, 16);
   double cax_p[16], *cax = cax_p;
   int cax_len = expansionObject::Gen_Diff_With_PreAlloc(cxd2_len, cxd2, l2xm_len, l2xm, &cax, 16);
   double cay_p[16], *cay = cay_p;
   int cay_len = expansionObject::Gen_Diff_With_PreAlloc(cyd2_len, cyd2, l2ym_len, l2ym, &cay, 16);
   double caz_p[16], *caz = caz_p;
   int caz_len = expansionObject::Gen_Diff_With_PreAlloc(czd2_len, czd2, l2zm_len, l2zm, &caz, 16);
   double qax_p[16], *qax = qax_p;
   int qax_len = expansionObject::Gen_Diff_With_PreAlloc(qxd2_len, qxd2, l2xm_len, l2xm, &qax, 16);
   double qay_p[16], *qay = qay_p;
   int qay_len = expansionObject::Gen_Diff_With_PreAlloc(qyd2_len, qyd2, l2ym_len, l2ym, &qay, 16);
   double qaz_p[16], *qaz = qaz_p;
   int qaz_len = expansionObject::Gen_Diff_With_PreAlloc(qzd2_len, qzd2, l2zm_len, l2zm, &qaz, 16);
   double cx1_p[16], *cx1 = cx1_p;
   int cx1_len = expansionObject::Gen_Product_With_PreAlloc(bay_len, bay, caz_len, caz, &cx1, 16);
   double cx2_p[16], *cx2 = cx2_p;
   int cx2_len = expansionObject::Gen_Product_With_PreAlloc(baz_len, baz, cay_len, cay, &cx2, 16);
   ...
   if (bay_p != bay) FreeDoubles(bay);
   if (bax_p != bax) FreeDoubles(bax);
   if (l2zm_p != l2zm) FreeDoubles(l2zm);
   if (l2ym_p != l2ym) FreeDoubles(l2ym);
   if (l2xm_p != l2xm) FreeDoubles(l2xm);
   if (qzd2_p != qzd2) FreeDoubles(qzd2);
   if (qyd2_p != qyd2) FreeDoubles(qyd2);
   if (qxd2_p != qxd2) FreeDoubles(qxd2);
   if (czd2_p != czd2) FreeDoubles(czd2);
   ...
   if (byd2_p != byd2) FreeDoubles(byd2);
   if (bxd2_p != bxd2) FreeDoubles(bxd2);
   if (d234_p != d234) FreeDoubles(d234);
   if (d34_p != d34) FreeDoubles(d34);
   if (d24_p != d24) FreeDoubles(d24);
   if (d23_p != d23) FreeDoubles(d23);
 }

#ifdef CHECK_FOR_XYZERFLOWS
   if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW)) return_value = inGabrielSphere_EIII_bigfloat(a, b, c, qx, qy, qz);
#endif
...
inline int inGabrielSphere_EIII(const genericPoint& a, const genericPoint& b, const genericPoint& c, double qx, double qy, double qz)
{
   ...
   if (ret != Filtered_Sign::UNCERTAIN) return ret;
   return inGabrielSphere_EIII_exact(a, b, c, qx, qy, qz);
}
...
inline int inGabrielSphere_IEEE_exact(const genericPoint& q, double ax, double ay, double az, double bx, double by, double bz, double cx, double cy, double cz)
{
 double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
   feclearexcept(FE_ALL_EXCEPT);
 ...
 q.getExactLambda(&l1x, l1x_len, &l1y, l1y_len, &l1z, l1z_len, &d1, d1_len);
 if ((d1[d1_len - 1] != 0))
 {
   double baxs[2];
   expansionObject::two_Diff(bx, ax, baxs);
   double bays[2];
   expansionObject::two_Diff(by, ay, bays);
   double bazs[2];
   expansionObject::two_Diff(bz, az, bazs);
   double caxs[2];
   expansionObject::two_Diff(cx, ax, caxs);
   double cays[2];
   expansionObject::two_Diff(cy, ay, cays);
   double cazs[2];
   expansionObject::two_Diff(cz, az, cazs);
   double bax_p[16], *bax = bax_p;
   int bax_len = expansionObject::Gen_Product_With_PreAlloc(2, baxs, d1_len, d1, &bax, 16);
   double bay_p[16], *bay = bay_p;
   int bay_len = expansionObject::Gen_Product_With_PreAlloc(2, bays, d1_len, d1, &bay, 16);
   double baz_p[16], *baz = baz_p;
   int baz_len = expansionObject::Gen_Product_With_PreAlloc(2, bazs, d1_len, d1, &baz, 16);
   double cax_p[16], *cax = cax_p;
   int cax_len = expansionObject::Gen_Product_With_PreAlloc(2, caxs, d1_len, d1, &cax, 16);
   double cay_p[16], *cay = cay_p;
   int cay_len = expansionObject::Gen_Product_With_PreAlloc(2, cays, d1_len, d1, &cay, 16);
   double caz_p[16], *caz = caz_p;
   int caz_len = expansionObject::Gen_Product_With_PreAlloc(2, cazs, d1_len, d1, &caz, 16);
   double axs_p[16], *axs = axs_p;
   int axs_len = expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, ax, &axs, 16);
   double ays_p[16], *ays = ays_p;
   int ays_len = expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, ay, &ays, 16);
   double azs_p[16], *azs = azs_p;
   int azs_len = expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, az, &azs, 16);
   double qax_p[16], *qax = qax_p;
   int qax_len = expansionObject::Gen_Diff_With_PreAlloc(l1x_len, l1x, axs_len, axs, &qax, 16);
   double qay_p[16], *qay = qay_p;
   int qay_len = expansionObject::Gen_Diff_With_PreAlloc(l1y_len, l1y, ays_len, ays, &qay, 16);
   double qaz_p[16], *qaz = qaz_p;
   int qaz_len = expansionObject::Gen_Diff_With_PreAlloc(l1z_len, l1z, azs_len, azs, &qaz, 16);
   double cx1_p[16], *cx1 = cx1_p;
   int cx1_len = expansionObject::Gen_Product_With_PreAlloc(bay_len, bay, caz_len, caz, &cx1, 16);
   double cx2_p[16], *cx2 = cx2_p;
   int cx2_len = expansionObject::Gen_Product_With_PreAlloc(baz_len, baz, cay_len, cay, &cx2, 16);
   ...
   if (qay_p != qay) FreeDoubles(qay);
   if (qax_p != qax) FreeDoubles(qax);
   if (azs_p != azs) FreeDoubles(azs);
   if (ays_p != ays) FreeDoubles(ays);
   if (axs_p != axs) FreeDoubles(axs);
   if (caz_p != caz) FreeDoubles(caz);
   if (cay_p != cay) FreeDoubles(cay);
   if (cax_p != cax) FreeDoubles(cax);
   if (baz_p != baz) FreeDoubles(baz);
...
#ifdef CHECK_FOR_XYZERFLOWS
   if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW)) return_value = inGabrielSphere_IEEE_bigfloat(q, ax, ay, az, bx, by, bz, cx, cy, cz);
#endif
...
inline int inGabrielSphere_IEEE(const genericPoint& q, double ax, double ay, double az, double bx, double by, double bz, double cx, double cy, double cz)
{
   ...
   if (ret != Filtered_Sign::UNCERTAIN) return ret;
   return inGabrielSphere_IEEE_exact(q, ax, ay, az, bx, by, bz, cx, cy, cz);
}
...
inline int inGabrielSphere_IIEE_exact(const genericPoint& q, const genericPoint& a, double bx, double by, double bz, double cx, double cy, double cz)
{
 double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
   feclearexcept(FE_ALL_EXCEPT);
 ...
 if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0))
 {
   ...
   double czd2_p[16], *czd2 = czd2_p;
   int czd2_len = expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, cz, &czd2, 16);
   double l1x2_p[16], *l1x2 = l1x2_p;
   int l1x2_len = expansionObject::Gen_Product_With_PreAlloc(l1x_len, l1x, d2_len, d2, &l1x2, 16);
   double l1y2_p[16], *l1y2 = l1y2_p;
   int l1y2_len = expansionObject::Gen_Product_With_PreAlloc(l1y_len, l1y, d2_len, d2, &l1y2, 16);
   double l1z2_p[16], *l1z2 = l1z2_p;
   int l1z2_len = expansionObject::Gen_Product_With_PreAlloc(l1z_len, l1z, d2_len, d2, &l1z2, 16);
   double baxs_p[16], *baxs = baxs_p;
   int baxs_len = expansionObject::Gen_Diff_With_PreAlloc(bxd2_len, bxd2, l2x_len, l2x, &baxs, 16);
   double bays_p[16], *bays = bays_p;
   int bays_len = expansionObject::Gen_Diff_With_PreAlloc(byd2_len, byd2, l2y_len, l2y, &bays, 16);
   double bazs_p[16], *bazs = bazs_p;
   int bazs_len = expansionObject::Gen_Diff_With_PreAlloc(bzd2_len, bzd2, l2z_len, l2z, &bazs, 16);
   double caxs_p[16], *caxs = caxs_p;
   int caxs_len = expansionObject::Gen_Diff_With_PreAlloc(cxd2_len, cxd2, l2x_len, l2x, &caxs, 16);
   double cays_p[16], *cays = cays_p;
   int cays_len = expansionObject::Gen_Diff_With_PreAlloc(cyd2_len, cyd2, l2y_len, l2y, &cays, 16);
   double cazs_p[16], *cazs = cazs_p;
   int cazs_len = expansionObject::Gen_Diff_With_PreAlloc(czd2_len, czd2, l2z_len, l2z, &cazs, 16);
   double bax_p[16], *bax = bax_p;
   int bax_len = expansionObject::Gen_Product_With_PreAlloc(baxs_len, baxs, d1_len, d1, &bax, 16);
   double bay_p[16], *bay = bay_p;
   int bay_len = expansionObject::Gen_Product_With_PreAlloc(bays_len, bays, d1_len, d1, &bay, 16);
   double baz_p[16], *baz = baz_p;
   int baz_len = expansionObject::Gen_Product_With_PreAlloc(bazs_len, bazs, d1_len, d1, &baz, 16);
   double cax_p[16], *cax = cax_p;
   int cax_len = expansionObject::Gen_Product_With_PreAlloc(caxs_len, caxs, d1_len, d1, &cax, 16);
   double cay_p[16], *cay = cay_p;
   int cay_len = expansionObject::Gen_Product_With_PreAlloc(cays_len, cays, d1_len, d1, &cay, 16);
   double caz_p[16], *caz = caz_p;
   int caz_len = expansionObject::Gen_Product_With_PreAlloc(cazs_len, cazs, d1_len, d1, &caz, 16);
   double l2x1_p[16], *l2x1 = l2x1_p;
   int l2x1_len = expansionObject::Gen_Product_With_PreAlloc(l2x_len, l2x, d1_len, d1, &l2x1, 16);
   double l2y1_p[16], *l2y1 = l2y1_p;
   int l2y1_len = expansionObject::Gen_Product_With_PreAlloc(l2y_len, l2y, d1_len, d1, &l2y1, 16);
   double l2z1_p[16], *l2z1 = l2z1_p;
   int l2z1_len = expansionObject::Gen_Product_With_PreAlloc(l2z_len, l2z, d1_len, d1, &l2z1, 16);
   double qax_p[16], *qax = qax_p;
   int qax_len = expansionObject::Gen_Diff_With_PreAlloc(l1x2_len, l1x2, l2x1_len, l2x1, &qax, 16);
   double qay_p[16], *qay = qay_p;
   int qay_len = expansionObject::Gen_Diff_With_PreAlloc(l1y2_len, l1y2, l2y1_len, l2y1, &qay, 16);
   double qaz_p[16], *qaz = qaz_p;
   int qaz_len = expansionObject::Gen_Diff_With_PreAlloc(l1z2_len, l1z2, l2z1_len, l2z1, &qaz, 16);
   double cx1_p[16], *cx1 = cx1_p;
   int cx1_len = expansionObject::Gen_Product_With_PreAlloc(bay_len, bay, caz_len, caz, &cx1, 16);
   double cx2_p[16], *cx2 = cx2_p;
   int cx2_len = expansionObject::Gen_Product_With_PreAlloc(baz_len, baz, cay_len, cay, &cx2, 16);
   ...
   if (qay_p != qay) FreeDoubles(qay);
   if (qax_p != qax) FreeDoubles(qax);
   if (l2z1_p != l2z1) FreeDoubles(l2z1);
   if (l2y1_p != l2y1) FreeDoubles(l2y1);
   if (l2x1_p != l2x1) FreeDoubles(l2x1);
   if (caz_p != caz) FreeDoubles(caz);
   if (cay_p != cay) FreeDoubles(cay);
   if (cax_p != cax) FreeDoubles(cax);
   if (baz_p != baz) FreeDoubles(baz);
   if (bay_p != bay) FreeDoubles(bay);
   if (bax_p != bax) FreeDoubles(bax);
   if (cazs_p != cazs) FreeDoubles(cazs);
   if (cays_p != cays) FreeDoubles(cays);
   if (caxs_p != caxs) FreeDoubles(caxs);
   if (bazs_p != bazs) FreeDoubles(bazs);
   if (bays_p != bays) FreeDoubles(bays);
   if (baxs_p != baxs) FreeDoubles(baxs);
   if (l1z2_p != l1z2) FreeDoubles(l1z2);
   if (l1y2_p != l1y2) FreeDoubles(l1y2);
   if (l1x2_p != l1x2) FreeDoubles(l1x2);
   if (czd2_p != czd2) FreeDoubles(czd2);
   if (cyd2_p != cyd2) FreeDoubles(cyd2);
   if (cxd2_p != cxd2) FreeDoubles(cxd2);
   if (bzd2_p != bzd2) FreeDoubles(bzd2);
...
#ifdef CHECK_FOR_XYZERFLOWS
   if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW)) return_value = inGabrielSphere_IIEE_bigfloat(q, a, bx, by, bz, cx, cy, cz);
#endif
...
inline int inGabrielSphere_IIEE(const genericPoint& q, const genericPoint& a, double bx, double by, double bz, double cx, double cy, double cz)
{
   ...
   if (ret != Filtered_Sign::UNCERTAIN) return ret;
   return inGabrielSphere_IIEE_exact(q, a, bx, by, bz, cx, cy, cz);
}
...
inline int inGabrielSphere_IIIE_exact(const genericPoint& q, const genericPoint& a, const genericPoint& b, double cx, double cy, double cz)
{
 double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
   feclearexcept(FE_ALL_EXCEPT);
 ...
 if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0))
 {
   double d12_p[16], *d12 = d12_p;
   int d12_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, d2_len, d2, &d12, 16);
   double d23_p[16], *d23 = d23_p;
   int d23_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, d3_len, d3, &d23, 16);
   double d13_p[16], *d13 = d13_p;
   int d13_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, d3_len, d3, &d13, 16);
   double d123_p[16], *d123 = d123_p;
   int d123_len = expansionObject::Gen_Product_With_PreAlloc(d12_len, d12, d3_len, d3, &d123, 16);
   double bxd2_p[16], *bxd2 = bxd2_p;
   int bxd2_len = expansionObject::Gen_Product_With_PreAlloc(l3x_len, l3x, d12_len, d12, &bxd2, 16);
   double byd2_p[16], *byd2 = byd2_p;
   int byd2_len = expansionObject::Gen_Product_With_PreAlloc(l3y_len, l3y, d12_len, d12, &byd2, 16);
   double bzd2_p[16], *bzd2 = bzd2_p;
   int bzd2_len = expansionObject::Gen_Product_With_PreAlloc(l3z_len, l3z, d12_len, d12, &bzd2, 16);
   double cxd2_p[16], *cxd2 = cxd2_p;
   int cxd2_len = expansionObject::Gen_Scale_With_PreAlloc(d123_len, d123, cx, &cxd2, 16);
   double cyd2_p[16], *cyd2 = cyd2_p;
   int cyd2_len = expansionObject::Gen_Scale_With_PreAlloc(d123_len, d123, cy, &cyd2, 16);
   double czd2_p[16], *czd2 = czd2_p;
   int czd2_len = expansionObject::Gen_Scale_With_PreAlloc(d123_len, d123, cz, &czd2, 16);
   double qxd2_p[16], *qxd2 = qxd2_p;
   int qxd2_len = expansionObject::Gen_Product_With_PreAlloc(l1x_len, l1x, d23_len, d23, &qxd2, 16);
   double qyd2_p[16], *qyd2 = qyd2_p;
   int qyd2_len = expansionObject::Gen_Product_With_PreAlloc(l1y_len, l1y, d23_len, d23, &qyd2, 16);
   double qzd2_p[16], *qzd2 = qzd2_p;
   int qzd2_len = expansionObject::Gen_Product_With_PreAlloc(l1z_len, l1z, d23_len, d23, &qzd2, 16);
   double l2xm_p[16], *l2xm = l2xm_p;
   int l2xm_len = expansionObject::Gen_Product_With_PreAlloc(l2x_len, l2x, d13_len, d13, &l2xm, 16);
   double l2ym_p[16], *l2ym = l2ym_p;
   int l2ym_len = expansionObject::Gen_Product_With_PreAlloc(l2y_len, l2y, d13_len, d13, &l2ym, 16);
   double l2zm_p[16], *l2zm = l2zm_p;
   int l2zm_len = expansionObject::Gen_Product_With_PreAlloc(l2z_len, l2z, d13_len, d13, &l2zm, 16);
   double bax_p[16], *bax = bax_p;
   int bax_len = expansionObject::Gen_Diff_With_PreAlloc(bxd2_len, bxd2, l2xm_len, l2xm, &bax, 16);
   double bay_p[16], *bay = bay_p;
   int bay_len = expansionObject::Gen_Diff_With_PreAlloc(byd2_len, byd2, l2ym_len, l2ym, &bay, 16);
   ...
   if (byd2_p != byd2) FreeDoubles(byd2);
   if (bxd2_p != bxd2) FreeDoubles(bxd2);
   if (d123_p != d123) FreeDoubles(d123);
   if (d13_p != d13) FreeDoubles(d13);
   if (d23_p != d23) FreeDoubles(d23);
   if (d12_p != d12) FreeDoubles(d12);
 }

#ifdef CHECK_FOR_XYZERFLOWS
   if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW)) return_value = inGabrielSphere_IIIE_bigfloat(q, a, b, cx, cy, cz);
#endif
...
inline int inGabrielSphere_IIIE(const genericPoint& q, const genericPoint& a, const genericPoint& b, double cx, double cy, double cz)
{
   ...
   if (ret != Filtered_Sign::UNCERTAIN) return ret;
   return inGabrielSphere_IIIE_exact(q, a, b, cx, cy, cz);
}
...
inline int inGabrielSphere_IIII_exact(const genericPoint& q, const genericPoint& a, const genericPoint& b, const genericPoint& c)
{
 double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
   feclearexcept(FE_ALL_EXCEPT);
 ...
 if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0) && (d4[d4_len - 1] != 0))
 {
   ...
   int d34_len = expansionObject::Gen_Product_With_PreAlloc(d3_len, d3, d4_len, d4, &d34, 16);
   double d123_p[16], *d123 = d123_p;
   int d123_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, d23_len, d23, &d123, 16);
   double d124_p[16], *d124 = d124_p;
   int d124_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, d24_len, d24, &d124, 16);
   double d134_p[16], *d134 = d134_p;
   int d134_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, d34_len, d34, &d134, 16);
   double d234_p[16], *d234 = d234_p;
   int d234_len = expansionObject::Gen_Product_With_PreAlloc(d23_len, d23, d4_len, d4, &d234, 16);
   double bxd2_p[16], *bxd2 = bxd2_p;
   int bxd2_len = expansionObject::Gen_Product_With_PreAlloc(l3x_len, l3x, d124_len, d124, &bxd2, 16);
   double byd2_p[16], *byd2 = byd2_p;
   int byd2_len = expansionObject::Gen_Product_With_PreAlloc(l3y_len, l3y, d124_len, d124, &byd2, 16);
   double bzd2_p[16], *bzd2 = bzd2_p;
   int bzd2_len = expansionObject::Gen_Product_With_PreAlloc(l3z_len, l3z, d124_len, d124, &bzd2, 16);
   double cxd2_p[16], *cxd2 = cxd2_p;
   int cxd2_len = expansionObject::Gen_Product_With_PreAlloc(l4x_len, l4x, d123_len, d123, &cxd2, 16);
   double cyd2_p[16], *cyd2 = cyd2_p;
   int cyd2_len = expansionObject::Gen_Product_With_PreAlloc(l4y_len, l4y, d123_len, d123, &cyd2, 16);
   double czd2_p[16], *czd2 = czd2_p;
   int czd2_len = expansionObject::Gen_Product_With_PreAlloc(l4z_len, l4z, d123_len, d123, &czd2, 16);
   double qxd2_p[16], *qxd2 = qxd2_p;
   int qxd2_len = expansionObject::Gen_Product_With_PreAlloc(l1x_len, l1x, d234_len, d234, &qxd2, 16);
   double qyd2_p[16], *qyd2 = qyd2_p;
   int qyd2_len = expansionObject::Gen_Product_With_PreAlloc(l1y_len, l1y, d234_len, d234, &qyd2, 16);
   double qzd2_p[16], *qzd2 = qzd2_p;
   int qzd2_len = expansionObject::Gen_Product_With_PreAlloc(l1z_len, l1z, d234_len, d234, &qzd2, 16);
   double l2xm_p[16], *l2xm = l2xm_p;
   int l2xm_len = expansionObject::Gen_Product_With_PreAlloc(l2x_len, l2x, d134_len, d134, &l2xm, 16);
   double l2ym_p[16], *l2ym = l2ym_p;
   int l2ym_len = expansionObject::Gen_Product_With_PreAlloc(l2y_len, l2y, d134_len, d134, &l2ym, 16);
   double l2zm_p[16], *l2zm = l2zm_p;
   int l2zm_len = expansionObject::Gen_Product_With_PreAlloc(l2z_len, l2z, d134_len, d134, &l2zm, 16);
   double bax_p[16], *bax = bax_p;
   int bax_len = expansionObject::Gen_Diff_With_PreAlloc(bxd2_len, bxd2, l2xm_len, l2xm, &bax, 16);
   double bay_p[16], *bay = bay_p;
   int bay_len = expansionObject::Gen_Diff_With_PreAlloc(byd2_len, byd2, l2ym_len, l2ym, &bay, 16);
   ...
   if (bxd2_p != bxd2) FreeDoubles(bxd2);
   if (d234_p != d234) FreeDoubles(d234);
   if (d134_p != d134) FreeDoubles(d134);
   if (d124_p != d124) FreeDoubles(d124);
   if (d123_p != d123) FreeDoubles(d123);
   if (d34_p != d34) FreeDoubles(d34);
   if (d24_p != d24) FreeDoubles(d24);
   if (d23_p != d23) FreeDoubles(d23);
...
#ifdef CHECK_FOR_XYZERFLOWS
   if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW)) return_value = inGabrielSphere_IIII_bigfloat(q, a, b, c);
#endif
...
inline int inGabrielSphere_IIII(const genericPoint& q, const genericPoint& a, const genericPoint& b, const genericPoint& c)
{
   ...
   if (ret != Filtered_Sign::UNCERTAIN) return ret;
   return inGabrielSphere_IIII_exact(q, a, b, c);
}
