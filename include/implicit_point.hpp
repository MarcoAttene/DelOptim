...
inline int genericPoint::inGabrielSphere(const genericPoint& a, const genericPoint& b, const genericPoint& c, const genericPoint& d)
{
	...
	if (i == 3)
	{
		...
		if (!c.isExplicit3D()) return inGabrielSphere_EIEE(a, c, d, b);
	...
	if (i == 2)
	{
		...
		if (b.isExplicit3D() && d.isExplicit3D()) return inGabrielSphere_IIEE(a, c, d, b);
		...
		if (a.isExplicit3D() && c.isExplicit3D()) return inGabrielSphere_EIIE(a, d, b, c);
	...
	if (i == 1)
	{
		...
		if (c.isExplicit3D()) return inGabrielSphere_IIIE(a, d, b, c);
