...
void exactinit(int = 0, int = 0, int = 0, REAL = 0, REAL = 0, REAL = 0);
...
#define fastlookup(pool, index) \
	...
	static inline REAL dot(REAL* v1, REAL* v2);
	static inline void cross(REAL* v1, REAL* v2, REAL* n);
	static bool lu_decmp(REAL lu[4][4], int n, int* ps, REAL* d, int N);
	static void lu_solve(REAL lu[4][4], int n, int* ps, REAL* b, int N);
	...
	static bool circumsphere(REAL*, REAL*, REAL*, REAL*, REAL* cent, REAL* radius);
