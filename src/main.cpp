...
void  printUsageAndExit() {
	cout << "Creates a well-shaped and conformal tetrahedral mesh out of a "
		 ...
		 << "[-b]\tsaves the input to the 'enriched CDT' phase.\n"
		 ...
		 << "[-w]\tsaves the outer boundary of the intermediate "
			"Delaunay-refined mesh (see OUTPUT).\n"
		 << "[-x]\tsaves the intermediate Delaunay-refined mesh (see OUTPUT).\n"
		 << "[-y]\tsaves the outer boundary of output mesh "
			"(see OUTPUT).\n"
		 << "[-z]\tsaves the output (see OUTPUT).\n"
		 << "OUTPUT:\n"
